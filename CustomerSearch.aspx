<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageCustomer.master" AutoEventWireup="true" CodeFile="CustomerSearch.aspx.cs" Inherits="CustomerSearch" %>
                       ...
                       <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                           ...
                           <Columns>
                               ...
                               <asp:TemplateField HeaderText="Date" SortExpression="schDate">
                                   <EditItemTemplate>
                                       <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("schDate","{0:dd-MM-yyyy}") %>'></asp:TextBox>
                                   </EditItemTemplate>
                                   <ItemTemplate>
                                       <asp:Label ID="Label1" runat="server" Text='<%# Bind("schDate","{0:dd-MM-yyyy}") %>'></asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                               ...
                               <asp:CommandField SelectText="Reservation" ShowSelectButton="True" />
                           </Columns>
