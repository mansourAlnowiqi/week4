...
public partial class Sch : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sql = "Insert into Sch (schDate,TypeID,Price,TankNo,AreaID) Values('" + tbdate.Text + "','" + cmbtype.SelectedValue + "','" + tbprice.Text + "','" + tbno.Text + "','" + cmbarea.SelectedValue + "')";
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sql = "Update Sch set schDate='" + tbdate.Text + "',TypeID='" + cmbtype.SelectedValue + "',TankNo='" + tbno.Text + "',Price="+tbprice.Text+",AreaID='"+cmbarea.SelectedValue +"'";
