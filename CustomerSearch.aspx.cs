...
public partial class CustomerSearch : System.Web.UI.Page
{
    ...
    void Search()
    {
        try
        {
            string sql = "Select * From Schdata where schDate>='"+DateTime.Now.Date.ToString("MM/dd/yyyy")+"' ";
            sql+= " and TypeID='"+cmbtype.SelectedValue +"'";
            sql += " and AreaID='" + cmbarea.SelectedValue + "'";
