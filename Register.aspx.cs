...
public partial class Register : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                lblerr.Text = "Please input Patient password";
                return;
            }

            if (tbphone.Text.Length < 10)
            {
                lblerr.Text = "Please input Patient phone no in 10 number";
                return;
            }
            ...
            if (tbemail.Text == "")
            {
                lblerr.Text = "please input patient email";
                return;
            }
            if (tbemail.Text.IndexOf("@") == -1 || tbemail.Text.IndexOf(".") == -1)
            {
                lblerr.Text = "please input patient email in correct format";
                return;
            }
